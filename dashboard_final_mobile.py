...
def load_data():
    ...
    try:
        ...
        # URL para OT_MASTER
        ot_master_url = "https://docs.google.com/spreadsheets/d/17eEYewfzoBZXkFWBm5DOJp3IuvHg9WvN/edit?usp=sharing&ouid=950986814&rtpof=true&sd=true"
        ot_master_csv = ot_master_url.replace('/edit?usp=sharing', '/export?format=csv')
        
        # URL para PROCESOS  
        procesos_url = "https://docs.google.com/spreadsheets/d/17eEYewfzoBZXkFWBm5DOJp3IuvHg9WvN/edit?usp=sharing&ouid=813063462&rtpof=true&sd=true"
